...
function Footer({extraCss=''}) {
    ...
    const Footer = ({extraCss=''}) => {
        return (
            <div className="w-full flex flex-col lg:flex-row lg:justify-between lg:items-center gap-[2vmax] lg:gap-0 mt-6">
                <div className=''>
                ...
                <P text={'@ ochi design 2024.'} className='opacity-[.4] text-sm' />
                <div className="credits">
                    <P text={'Website by - Obeys.'} className='opacity-[.4] text-sm mb-1'/>
                    <P text={'Clonned by - Byimaan Subh.'} className='opacity-[.4] text-sm' />
                </div>
            </div>
        )
    };
    ...
    return (
        <div className={` w-full px-7 lg:px-14 py-[6.5vmin] bg-zinc-900  ${extraCss}`}>
            <Header />
            <Footer />
        </div>
    )
